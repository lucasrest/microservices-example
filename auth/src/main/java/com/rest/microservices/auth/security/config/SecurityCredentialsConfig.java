package com.rest.microservices.auth.security.config;

import com.rest.microservices.auth.security.filter.UsernameAndPasswordAuthenticationFilter;
...
public class SecurityCredentialsConfig extends SecurityTokenConfig {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .addFilter(new UsernameAndPasswordAuthenticationFilter(authenticationManager(), jwtConfiguration, tokenCreator))
